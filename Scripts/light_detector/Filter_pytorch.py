...
def set_parser():
    ...
    parser.add_argument('-s','--source', type=str, default='./Scripts/LDR2HDR/images_HDR', help='Choose source folder')
    parser.add_argument('-st','--source_type', type=str, default='HDR', help='Image type of source')
    parser.add_argument('-to','--tend_output',type= str, default='./Scripts/light_detector/to_predict',help='Tend and Hdr mix')
...
def start(parser):
    ...
    print(f"Filter Time cost {elapsed_time}\n")
